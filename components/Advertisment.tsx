...
const cards: ContentCard[] = [
  {
    ...
    description: "Les mer om våre konkurranselag, treninger og turneringer.",
    image: "/esport-background.png",
  },
  {
    title: "Nyheter",
    author: "Av Andreas og Shope",
    description: "Få med deg siste nytt fra Tiller E-Sport og kommende events.",
    image: "/esport-background.png",
  },
];
          ...
          {cards.map((card, index) => (
            ...
            >
              ...
              <CardContent className="p-6">
                ...
                <p className="mb-2 text-sm text-gray-500">{card.author}</p>
